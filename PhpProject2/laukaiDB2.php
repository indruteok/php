...
<html>
    ...
    //         
       ...
       $write=  fwrite($fp, $_POST['email']."\r\n");
       fclose($fp);
       
       
       $read= file("pastai.txt");  // skaitymas
       
       print_r($read); // isspausdinimas
      // 
            ...
            if (mysqli_connect_errno()) {
                ...
                $uzklausa = "INSERT INTO testTABLE2" .
                        "( vardas , emailas , pasirinkimas  , komentaras  ) VALUES('".$_POST['name']."', '".$_POST['email']."', '".$_POST['rad']."', '".$_POST['coment']."' )";
                mysqli_query($mysqli, $uzklausa);
